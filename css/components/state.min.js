      ...
      return (
        i.each(function () {
          ...
          (n = {
            ...
            add: {
              defaults: function () {
                ...
                e.each(d.defaults, function (t, i) {
                  void 0 !== n.is[t] &&
                    n.is[t]() &&
                    (n.verbose("Adding default states", t, y),
                    e.extend(d.states, i, a));
                });
              },
            },
            is: {
            ...
            deactivate: function () {
              d.deactivateTest.call(y) &&
                (n.debug("Setting state to inactive"),
                T.removeClass(g.active),
                n.update.text(h.inactive),
                d.onDeactivate.call(y));
            },
            sync: function () {
              n.verbose("Syncing other buttons to current state"),
                n.is.active()
                  ? i.not(T).state("activate")
                  : i.not(T).state("deactivate");
            },
            get: {
              text: function () {
                return d.selector.text
                  ? T.find(d.selector.text).text()
                  : T.html();
              },
              textFor: function (e) {
                return h[e] || !1;
              ...
              text: function (e) {
                ...
                e && e !== t
                  ? (n.debug("Updating text", e),
                    d.selector.text
                      ? T.data(f.storedText, e).find(d.selector.text).text(e)
                      : T.data(f.storedText, e).html(e))
                  : n.debug("Text is already set, ignoring update", e);
              },
            },
            setting: function (t, a) {
              if ((n.debug("Changing setting", t, a), e.isPlainObject(t)))
                e.extend(!0, d, t);
              else {
            ...
            l
              ? (void 0 === w && n.initialize(), n.invoke(r))
