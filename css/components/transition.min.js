          ...
          (w = {
            initialize: function () {
              (m = w.get.settings.apply(A, l)),
                ...
                c && (c = w.invoke(d)),
                !1 === c &&
                  (w.verbose("Converted arguments into settings object", m),
            ...
            delay: function (n) {
              ...
              o || (o = w.can.transition() ? w.get.direction() : "static"),
                ...
                (t =
                  e || 1 == m.reverse
                    ? (a.length - i) * m.interval
                    : i * m.interval),
                w.debug("Delaying animation by", t),
                setTimeout(w.animate, t);
            },
            animate: function (n) {
              if (((m = n || m), !w.is.supported()))
                return w.error(p.support), !1;
              if (
                (w.debug("Preparing animation", m.animation), w.is.animating())
              ) {
                if (m.queue)
                  return (
                    !m.allowRepeats &&
              ...
              w.can.animate()
                ...
                : w.error(p.noAnimation, m.animation, A);
            },
            reset: function () {
                ...
                w.is.looping() ||
                  (w.is.outward()
                    ? (w.verbose("Animation is outward, hiding element"),
                      ...
                      w.hide())
                    : w.is.inward()
                    ? (w.verbose("Animation is outward, showing element"),
                      w.restore.conditions(),
                      w.show())
            ...
            force: {
              visible: function () {
                var n = C.attr("style"),
                  ...
                  o = void 0 === n || "" === n;
                a !== e
                  ? (w.verbose("Overriding default display to show element", e),
                    C.attr("style", t))
                  : o && C.removeAttr("style");
              },
              hidden: function () {
                var n = C.attr("style"),
                  i = C.css("display"),
                ...
                "none" === i || w.is.hidden()
                  ...
                  : (w.verbose("Overriding default display to hide element"),
                    C.css("display", "none"));
              },
            },
            has: {
            ...
            set: {
              ...
              duration: function (n, i) {
                (i = i || m.duration),
                  ((i = "number" == typeof i ? i + "ms" : i) || 0 === i) &&
                    (w.verbose("Setting animation duration", i),
                    C.css({ "animation-duration": i }));
              },
              direction: function (n) {
                (n = n || w.get.direction()),
                  n == g.inward ? w.set.inward() : w.set.outward();
              },
              looping: function () {
            ...
            save: {
              ...
              transitionExists: function (i, e) {
                (n.fn.transition.exists[i] = e),
                  w.verbose("Saving existence of transition", i, e);
              },
            },
            restore: {
              conditions: function () {
            ...
            get: {
              ...
              userStyle: function (n) {
                return (
                  (n = n || C.attr("style") || ""), n.replace(/display.*?;/, "")
                );
              },
              ...
              transition: function (i) {
                ...
                if (void 0 === d || i) {
                  if (
                    ...
                    if ("none" == o || !o)
                      return void w.debug("No animation defined in css", l);
            ...
            setting: function (i, e) {
              if ((w.debug("Changing setting", i, e), n.isPlainObject(i)))
                n.extend(!0, m, i);
              else {
                ...
                "string" == typeof i &&
                  ...
                  n.each(i, function (e, t) {
                    ...
                    if (n.isPlainObject(l[a]) && e != o) l = l[a];
                      ...
                      if (!n.isPlainObject(l[t]) || e == o)
                        return void 0 !== l[t] && ((r = l[t]), !1);
                      l = l[t];
                    }
                  })),
