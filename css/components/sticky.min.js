          ...
          (g = {
            ...
            destroy: function () {
              g.verbose("Destroying previous instance"),
                ...
                h && h.disconnect(),
                k
                  .off("load" + C, g.event.load)
                  .off("resize" + C, g.event.resize),
            ...
            determineContext: function () {
              if (((d = p.context ? e(p.context) : s), 0 === d.length))
                return void g.error(x.invalidContext, p.context, y);
            },
            checkErrors: function () {
              if (
                (g.is.hidden() && g.error(x.visible, y),
                g.cache.element.height > g.cache.context.height)
              )
                return g.reset(), void g.error(x.elementSize, y);
            },
            bind: {
              events: function () {
            ...
            get: {
              ...
              scrollChange: function (e) {
                return (
                  (e = e || z.scrollTop()), g.lastScroll ? e - g.lastScroll : 0
                );
              },
            ...
            set: {
              ...
              containerSize: function () {
                ...
                "HTML" === e || "body" == e
                  ? g.determineContainer()
                  : Math.abs(s.outerHeight() - g.cache.context.height) >
                      p.jitter &&
                    (g.debug(
                      "Context has padding, specifying exact height for container",
                      g.cache.context.height
                    ),
                    s.css({ height: g.cache.context.height }));
              },
              minimumSize: function () {
            ...
            stick: function (e) {
              var t = e || z.scrollTop(),
                ...
                a =
                  (g.get.direction(e.top), n ? 0 : g.get.elementScroll(e.top)),
                f = !n;
              0 !== s.height &&
                !i &&
            ...
            unfix: function () {
              g.is.fixed() &&
                ...
                g.remove.offset(),
                y.removeClass(b.fixed).removeClass(b.top).removeClass(b.bottom),
                p.onUnstick.call(B));
            },
            reset: function () {
            ...
            f
              ? (void 0 === T && g.initialize(), g.invoke(a))
