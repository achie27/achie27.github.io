          ...
          (f = {
            ...
            bind: {
              events: function () {
                f.verbose("Binding events to search"),
                  v.automatic &&
                    (x.on(f.get.inputEvent() + C, b.prompt, f.event.input),
            ...
            determine: {
              searchFields: function () {
                n &&
                  void 0 !== n.searchFields &&
                  (v.searchFields = n.searchFields);
              },
            },
            event: {
              input: function () {
              ...
              blur: function (e) {
                var t = s.activeElement === this,
                  n = function () {
                    f.cancel.query(),
                      f.remove.focus(),
                      (f.timer = setTimeout(f.hideResults, v.hideDelay));
                  };
                t ||
                  ((D = !1),
                  f.resultsClicked
              ...
              result: {
                ...
                click: function (s) {
                  ...
                  if (
                    e.isFunction(v.onSelect) &&
                    !1 === v.onSelect.call(S, l, u)
                  )
                    return (
                      f.debug(
                  ...
                  f.hideResults(),
                    c && f.set.value(c),
                    a &&
                      (f.verbose("Opening search link found in result", r),
                      "_blank" == o || s.ctrlKey
                        ? t.open(a)
                        : (t.location.href = a));
                },
            ...
            handleKeyboard: function (e) {
              ...
              if (
                ...
                c == u.enter &&
                  ...
                  f.query(),
                  f.set.buttonPressed(),
                  F.one("keyup", f.remove.buttonFocus));
            },
            setup: {
              api: function (t, s) {
                var n = {
                ...
                e.extend(!0, n, v.apiSettings),
                  f.verbose("Setting up API request", n),
                  x.api(n);
              },
            },
            can: {
            ...
            is: {
              ...
              inMessage: function (t) {
                if (t.target) {
                  var n = e(t.target);
                  return (
                    e.contains(s.documentElement, t.target) &&
                    n.closest(b.message).length > 0
                  );
                }
              },
              empty: function () {
                  ...
                  "category" === v.type
                    ? (f.debug("Finding result that matches", t),
                      e.each(s, function (s, r) {
                        if (
                          e.isArray(r.results) &&
                          (i = f.search.object(t, r.results, n)[0])
                        )
                          return !1;
                      }))
                    : (f.debug("Finding result in results object", t),
                      (i = f.search.object(t, s, n)[0])),
                  i || !1
                );
              },
            },
            ...
            query: function (t) {
              ...
              (t = t || function () {}),
                f.has.minimumCharacters()
                  ? (n
                      ? (f.debug("Reading result from cache", s),
              ...
              response: function (e, t) {
                ...
                f.verbose("Parsing server response", e),
                  void 0 !== e &&
                    ...
                    void 0 !== e[m.results] &&
                    (f.addResults(s),
                    f.inject.id(e[m.results]),
                    f.write.cache(t, { html: s, results: e[m.results] }),
            ...
            create: {
              ...
              results: function () {
                0 === k.length &&
                  (k = e("<div />").addClass(g.results).appendTo(x));
              },
            },
            inject: {
              result: function (e, t, s) {
                ...
                var n =
                  void 0 !== s
                    ? k.children().eq(s).children(b.result).eq(t)
                ...
                return (
                  "category" === v.type
                    ? e.each(t, function (t, i) {
                        (n = 0),
                          e.each(i.results, function (e, t) {
                            var r = i.results[e];
                            void 0 === r.id && (r.id = f.create.id(n, s)),
                              f.inject.result(r, n, s),
                              n++;
                          }),
                          s++;
                      })
                    : e.each(t, function (e, s) {
                        var i = t[e];
                        void 0 === i.id && (i.id = f.create.id(n)),
                          f.inject.result(i, n),
                          n++;
                      }),
                  t
            ...
            addResults: function (t) {
              if (
                e.isFunction(v.onResultsAdd) &&
                !1 === v.onResultsAdd.call(k, t)
              )
                return (
              ...
              t
                ? (k.html(t),
                  f.refreshResults(),
                  v.selectFirstResult && f.select.firstResult(),
                  f.showResults())
                  ...
                  (!f.is.visible() &&
                    ...
                    (f.can.transition()
                      ...
                      : (f.debug("Showing results with javascript"),
                        k.stop().fadeIn(v.duration, v.easing)),
                ...
                f.is.visible() &&
                  (f.can.transition()
                    ...
                    : (f.debug("Hiding results with javascript"),
                      k.stop().fadeOut(v.duration, v.easing)),
            ...
            generateResults: function (t) {
              ...
              var s = v.templates[v.type],
                n =
                  e.isPlainObject(t[m.results]) &&
                  !e.isEmptyObject(t[m.results]),
              ...
              return (
                n || i
                  ? (v.maxResults > 0 &&
                      (n
                        ? "standard" == v.type && f.error(y.maxResults)
                        : (t[m.results] = t[m.results].slice(0, v.maxResults))),
            ...
            displayMessage: function (e, t) {
              return (
                ...
                f.addResults(v.templates.message(e, t)),
                v.templates.message(e, t)
              );
            },
                ...
                "string" == typeof t &&
                  ...
                  e.each(t, function (s, n) {
                    ...
                    if (e.isPlainObject(c[i]) && s != r) c = c[i];
                      ...
                      if (!e.isPlainObject(c[n]) || s == r)
                        return void 0 !== c[n] && ((a = c[n]), !1);
                      c = c[n];
                    }
                  })),
            ...
            l
              ? (void 0 === E && f.initialize(), f.invoke(u))
          ...
          return (
            ...
            (e.each(t[s.categoryResults], function (t, i) {
              void 0 !== i[s.results] &&
                ...
                void 0 !== i[s.categoryName] &&
                  (n += '<div class="name">' + i[s.categoryName] + "</div>"),
                e.each(i.results, function (e, t) {
                  t[s.url]
