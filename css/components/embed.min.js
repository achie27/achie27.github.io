          ...
          (s = {
            ...
            bind: {
              events: function () {
                s.has.placeholder() &&
                  ...
                  C.on("click" + w, p.placeholder, s.createAndShow).on(
                    "click" + w,
                    p.icon,
                    s.createAndShow
                  ));
            ...
            createPlaceholder: function (e) {
              ...
              (e = e || s.get.placeholder()),
                C.html(y.placeholder(e, o)),
                s.debug("Creating placeholder for embed", e, o);
            },
            ...
            determine: {
              ...
              url: function () {
                ...
                return (
                  (e = void 0 !== h[n] && h[n].url.replace("{id}", o)),
                  e && C.data(v.url, e),
                  e
                );
              },
            ...
            generate: {
              embed: function (e) {
                ...
                return (
                  (e = s.get.url(e)),
                  e
                    ? ((n = s.generate.parameters(t)), (o = y.iframe(e, n)))
                    : s.error(b.noURL, C),
                  o
                );
              },
              parameters: function (o, n) {
                var t =
                  h[o] && void 0 !== h[o].parameters ? h[o].parameters(m) : {};
                return (
                  (n = n || m.parameters),
                  n && (t = e.extend({}, t, n)),
                  (t = m.onEmbed(t)),
                  s.encode.parameters(t)
                );
              },
            },
            has: {
            ...
            should: {
              autoplay: function () {
                return "auto" === m.autoplay
                  ? m.placeholder || void 0 !== C.data(v.placeholder)
                  : m.autoplay;
              },
            },
            is: {
            ...
            setting: function (o, n) {
              if ((s.debug("Changing setting", o, n), e.isPlainObject(o)))
                e.extend(!0, m, o);
              else {
            ...
            d
              ? (void 0 === T && s.initialize(), s.invoke(l))
              : (void 0 !== T && T.invoke("destroy"), s.initialize());
        }),
        void 0 !== t ? t : this
      );
    }),
