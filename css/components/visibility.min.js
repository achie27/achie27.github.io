      ...
      return (
        s.each(function () {
          var s,
            ...
            g,
            p = e.isPlainObject(t)
              ? e.extend(!0, {}, e.fn.visibility.settings, t)
          ...
          (g = {
            ...
            destroy: function () {
              g.verbose("Destroying previous module"),
                m && m.disconnect(),
                b && b.disconnect(),
                S.off("load" + y, g.event.load).off(
                  "resize" + y,
                  g.event.resize
                ),
                k
                  .off("scroll" + y, g.event.scroll)
                  .off("scrollchange" + y, g.event.scrollchange),
                  ...
                  (p.onTopPassed = function () {
                    g.debug("Element passed, adding fixed position", V),
                      ...
                      p.transition &&
                        ...
                        V.transition(p.transition, p.duration);
                  }),
                  (p.onTopPassedReverse = function () {
                    g.debug("Element returned to position, removing fixed", V),
                      g.hide.placeholder(),
                      g.remove.fixed();
                  });
              },
            ...
            checkVisibility: function (e) {
              g.verbose("Checking visibility of element", g.cache.element),
                !A &&
                  ...
                  g.bottomPassed(),
                  p.onUpdate &&
                    p.onUpdate.call(z, g.get.elementCalculations()));
            },
            passed: function (o, n) {
              ...
              if (o && n) p.onPassed[o] = n;
                ...
                t.passing &&
                  e.each(p.onPassed, function (e, o) {
                    t.bottomVisible || t.pixelsPassed > g.get.pixelsPassed(e)
                      ? g.execute(o, e)
            ...
            onScreen: function (e) {
              ...
              if (
                ...
                o.onScreen
                  ...
                  : p.once || g.remove.occurred("onScreen"),
                void 0 !== e)
              )
                return o.onOnScreen;
            },
            offScreen: function (e) {
              ...
              if (
                ...
                o.offScreen
                  ...
                  : p.once || g.remove.occurred("offScreen"),
                void 0 !== e)
              )
            ...
            passing: function (e) {
              ...
              if (
                ...
                o.passing
                  ? g.execute(n, "passing")
                  : p.once || g.remove.occurred("passing"),
                void 0 !== e)
              )
                return o.passing;
            },
            topVisible: function (e) {
              ...
              if (
                ...
                o.topVisible
                  ...
                  : p.once || g.remove.occurred("topVisible"),
                void 0 === e)
              )
                return o.topVisible;
            },
            bottomVisible: function (e) {
              ...
              if (
                ...
                o.bottomVisible
                  ...
                  : p.once || g.remove.occurred("bottomVisible"),
                void 0 === e)
              )
            ...
            topPassed: function (e) {
              ...
              if (
                ...
                o.topPassed
                  ...
                  : p.once || g.remove.occurred("topPassed"),
                void 0 === e)
              )
                return o.topPassed;
            },
            bottomPassed: function (e) {
              ...
              if (
                ...
                o.bottomPassed
                  ...
                  : p.once || g.remove.occurred("bottomPassed"),
                void 0 === e)
              )
            ...
            passingReverse: function (e) {
              ...
              if (
                ...
                o.passing
                  ? p.once || g.remove.occurred("passingReverse")
                  : g.get.occurred("passing") && g.execute(n, "passingReverse"),
                void 0 !== e)
              )
                return !o.passing;
            },
            topVisibleReverse: function (e) {
              ...
              if (
                ...
                o.topVisible
                  ? p.once || g.remove.occurred("topVisibleReverse")
            ...
            bottomVisibleReverse: function (e) {
              ...
              if (
                ...
                o.bottomVisible
                  ? p.once || g.remove.occurred("bottomVisibleReverse")
            ...
            topPassedReverse: function (e) {
              ...
              if (
                ...
                o.topPassed
                  ? p.once || g.remove.occurred("topPassedReverse")
            ...
            bottomPassedReverse: function (e) {
              ...
              if (
                ...
                o.bottomPassed
                  ? p.once || g.remove.occurred("bottomPassedReverse")
            ...
            execute: function (e, o) {
              ...
              (e = e || !1),
                e &&
                  (p.continuous
                    ? (g.debug("Callback being called continuously", o, n),
                      e.call(z, n, t))
                    : g.get.occurred(o) ||
                      (g.debug("Conditions met", o, n), e.call(z, n, t))),
                g.save.occurred(o);
            },
            remove: {
              fixed: function () {
                g.debug("Removing fixed position"),
                  V.removeClass(h.fixed).css({
                    position: "",
                    top: "",
                    left: "",
                    zIndex: "",
            ...
            save: {
              ...
              scroll: function (e) {
                (e = e + p.offset || k.scrollTop() + p.offset),
                  (g.cache.scroll = e);
              },
              direction: function () {
                var e,
              ...
              elementPosition: function () {
                ...
                return (
                  ...
                  g.is.verticallyScrollableContext() &&
                    (e.offset.top += k.scrollTop() - k.offset().top),
                  g.is.horizontallyScrollableContext() &&
                    (e.offset.left += k.scrollLeft - k.offset().left),
                  (g.cache.element = e),
                  e
                );
              },
              ...
              screenSize: function () {
                g.verbose("Saving window position"),
                  (g.cache.screen = { height: k.height() });
              },
              position: function () {
            ...
            get: {
              ...
              occurred: function (e) {
                return (
                  void 0 !== g.cache.occurred && (g.cache.occurred[e] || !1)
                );
              },
              direction: function () {
                return (
              ...
              elementCalculations: function () {
                return (
                  void 0 === g.cache.element && g.save.elementCalculations(),
                  g.cache.element
                );
              },
              screenCalculations: function () {
                return (
                  void 0 === g.cache.screen && g.save.screenCalculations(),
                  g.cache.screen
                );
              },
              screenSize: function () {
              ...
              scroll: function () {
                return (
                  void 0 === g.cache.scroll && g.save.scroll(), g.cache.scroll
                );
              },
              lastScroll: function () {
                ...
                "string" == typeof o &&
                  ...
                  e.each(o, function (n, t) {
                    var i =
                      n != s
                        ? t +
                          o[n + 1].charAt(0).toUpperCase() +
                          o[n + 1].slice(1)
                        : o;
                    if (e.isPlainObject(a[i]) && n != s) a = a[i];
                    else {
                      if (void 0 !== a[i]) return (c = a[i]), !1;
                      if (!e.isPlainObject(a[t]) || n == s)
                        return void 0 !== a[t]
                          ? ((c = a[t]), !1)
                          : (g.error(x.method, o), !1);
                      a = a[t];
                    }
                  })),
            ...
            d
              ? (void 0 === T && g.initialize(),
                T.save.scroll(),
                T.save.calculations(),
                g.invoke(l))
              : (void 0 !== T && T.invoke("destroy"), g.initialize());
        }),
        void 0 !== i ? i : this
      );
    }),
